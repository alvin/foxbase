  ...
  _createClass(BaseModel, [{
    ...
    value: function remove(itemId, obj) {
      ...
      if (!obj || (typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) !== 'object') return Promise.reject('Invalid input provided to BaseModel.remove() - obj required');else {
        var updates = {};
        if (obj.domains) obj.domains.forEach(function (domain) {
          updates['wildcards-' + _this3.modelName + '/' + domain.replace(/\./g, '%2E') + '/' + itemId] = null;
        });
        ...
        return firebase.database().ref().update(updates).catch(function (err) {
          ...
          return _get(BaseModel.prototype.__proto__ || Object.getPrototypeOf(BaseModel.prototype), 'remove', _this3).call(_this3, 'root', itemId, obj);
        });
      }
    }
  }, {
