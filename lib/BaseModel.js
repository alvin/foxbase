...
var BaseModel = function (_Model) {
  ...
  _createClass(BaseModel, [{
    ...
    key: 'remove',
    value: function remove(itemId, obj, updates) {
      var _this3 = this;

      if (!obj || (typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) !== 'object') return Promise.reject('Invalid input provided to BaseModel.remove() - obj required');else {
        var updates = {};
        return firebase.database().ref(this.modelName + '-wildcards/' + itemId).once('value').catch(function (err) {
          ...
          return _get(BaseModel.prototype.__proto__ || Object.getPrototypeOf(BaseModel.prototype), 'remove', _this3).call(_this3, 'root', itemId, obj, updates);
        });
      }
    }
  }, {
