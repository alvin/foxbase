...
var Model = function () {
  ...
  _createClass(Model, [{
    ...
    value: function write(parentId, itemId, obj, blobs) {
      ...
      if (!parentId || !itemId || typeof parentId != 'string' || (typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) != 'object' && typeof obj != 'null' || typeof itemId != 'string') return Promise.reject('Invalid input provided to write()');else return firebase.database().ref(this.itemLocation(parentId, itemId)).set(obj).then(function () {
    ...
    value: function remove(parentId, itemId, obj) {
      ...
      if ((typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) !== 'object' || !parentId || typeof parentId !== 'string' || !itemId || typeof itemId !== 'string') return Promise.reject('Invalid input provided to delete()');else {
        var updates = {};
